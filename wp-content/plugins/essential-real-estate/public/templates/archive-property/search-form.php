...
$hide_archive_search_fields = ere_get_option('hide_archive_search_fields', array('property_country', 'property_state', 'property_neighborhood', 'property_label','property_rooms'));
...
$rooms_enable = !in_array("property_rooms", $hide_archive_search_fields);
...
echo do_shortcode('[ere_property_advanced_search layout="tab" column="3" color_scheme="color-dark" status_enable="' . ($status_enable ? 'true' : 'false') . '" type_enable="' . ($type_enable ? 'true' : 'false') . '" title_enable="' . ($title_enable ? 'true' : 'false') . '" keyword_enable="'. ($keyword_enable ? 'true' : 'false') .'" address_enable="' . ($address_enable ? 'true' : 'false') . '" country_enable="' . ($country_enable ? 'true' : 'false') . '" state_enable="' . ($state_enable ? 'true' : 'false') . '"  city_enable="' . ($city_enable ? 'true' : 'false') . '"  neighborhood_enable="' . ($neighborhood_enable ? 'true' : 'false') . '" rooms_enable="' . ($rooms_enable ? 'true' : 'false') . '" bedrooms_enable="' . ($bedrooms_enable ? 'true' : 'false') . '" bathrooms_enable="' . ($bathrooms_enable ? 'true' : 'false') . '" price_enable="' . ($price_enable ? 'true' : 'false') . '" price_is_slider="' . (($property_price_field_layout == '1') ? 'true' : 'false') . '" area_enable="' . ($area_enable ? 'true' : 'false') . '" area_is_slider="' . (($property_size_field_layout == '1') ? 'true' : 'false') . '" land_area_enable="' . ($land_area_enable ? 'true' : 'false') . '" land_area_is_slider="' . (($property_land_field_layout == '1') ? 'true' : 'false') . '" label_enable="' . ($label_enable ? 'true' : 'false') . '" garage_enable="' . ($garage_enable ? 'true' : 'false') . '" property_identity_enable="' . ($property_identity_enable ? 'true' : 'false') . '" other_features_enable="' . ($other_features_enable ? 'true' : 'false') . '"]');